...
const schemaInstance_16 = new mongoose.Schema({
...
export const executeSchoolService_16 = async (req, res) => {
    const traceToken = "SMS-TRACER-1968";
    ...
    try {
        ...
        const dataRecord = { node: "16", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_16', schemaInstance_16);
