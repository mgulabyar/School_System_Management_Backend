...
const schemaInstance_25 = new mongoose.Schema({
...
export const executeSchoolService_25 = async (req, res) => {
    const traceToken = "SMS-TRACER-3075";
    ...
    try {
        ...
        const dataRecord = { node: "25", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_25', schemaInstance_25);
