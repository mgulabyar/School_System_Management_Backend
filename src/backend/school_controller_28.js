...
const schemaInstance_28 = new mongoose.Schema({
...
export const executeSchoolService_28 = async (req, res) => {
    const traceToken = "SMS-TRACER-3444";
    ...
    try {
        ...
        const dataRecord = { node: "28", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_28', schemaInstance_28);
