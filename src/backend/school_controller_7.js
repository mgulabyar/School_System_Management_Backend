...
const schemaInstance_7 = new mongoose.Schema({
...
export const executeSchoolService_7 = async (req, res) => {
    const traceToken = "SMS-TRACER-861";
    ...
    try {
        ...
        const dataRecord = { node: "7", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_7', schemaInstance_7);
