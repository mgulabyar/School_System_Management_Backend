...
const schemaInstance_3 = new mongoose.Schema({
...
export const executeSchoolService_3 = async (req, res) => {
    const traceToken = "SMS-TRACER-369";
    ...
    try {
        ...
        const dataRecord = { node: "3", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_3', schemaInstance_3);
