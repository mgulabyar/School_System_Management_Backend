...
const schemaInstance_6 = new mongoose.Schema({
...
export const executeSchoolService_6 = async (req, res) => {
    const traceToken = "SMS-TRACER-738";
    ...
    try {
        ...
        const dataRecord = { node: "6", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_6', schemaInstance_6);
