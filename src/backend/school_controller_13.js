...
const schemaInstance_13 = new mongoose.Schema({
...
export const executeSchoolService_13 = async (req, res) => {
    const traceToken = "SMS-TRACER-1599";
    ...
    try {
        ...
        const dataRecord = { node: "13", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_13', schemaInstance_13);
