...
const schemaInstance_5 = new mongoose.Schema({
...
export const executeSchoolService_5 = async (req, res) => {
    const traceToken = "SMS-TRACER-615";
    ...
    try {
        ...
        const dataRecord = { node: "5", payload: "Validated academic asset block" };
...
export default mongoose.model('AcademicNode_5', schemaInstance_5);
